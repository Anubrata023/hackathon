const SahayakChat = {
    ...
    responses: {
        en: {
            ...
            fallback: "I am still learning! You can ask me about 'electricity', 'gas', or 'complaints'.",
        ...
        as: {
            ...
            fallback: "মই এতিয়াও শিকি আছো! আপুনি মোক বিজুলী বা গেছৰ বিষয়ে সোধক।",
        ...
        hi: {
            ...
            fallback: "मैं अभी सीख रहा हूँ! कृपया 'बिजली' या 'गैस' के बारे में पूछें।",
    ...
    injectStyles: function() {
        ...
        style.innerHTML = `
            #sahayak-chat-wrapper { position: fixed; bottom: 90px; right: 30px; width: 350px; height: 500px; background: #fff; border-radius: 15px; box-shadow: 0 10px 40px rgba(0,0,0,0.25); display: none; flex-direction: column; overflow: hidden; z-index: 10000; font-family: 'Poppins', sans-serif; border: 2px solid #344F1F; transition: opacity 0.3s; }
